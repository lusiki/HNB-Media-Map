...
subtitle: "Prijedlog sustava za medijsko praćenje (u realnom vremenu)"
...
kable(desc_stats_table, 
  ...
  kable_styling(
    # 'responsive' opcija ponekad smeta scroll_box-u, pa je sigurnije maknuti je
    bootstrap_options = c("striped", "hover", "condensed"), 
    full_width = FALSE
  ) %>%
  
  # --- DODAJTE OVAJ DIO ---
  # Omotava tablicu u "kutiju" koja se može skrolati
  scroll_box(
    width = "100%",  # Neka kutija zauzme 100% širine
    height = "400px" # Fiksna visina. Prilagodite visinu (npr. "500px")
  )
```
...
-   [Repozitorij analize](https://github.com/lusiki/HNB-Media-Map)

...
format:
  revealjs:
    ...
    chalkboard: true
    # --- MOVED THESE LINES ---
    background-image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Croatian_National_Bank.jpg/500px-Croatian_National_Bank.jpg"
    background-size: cover
    background-opacity: "0.5" # Adjust opacity (0.0 to 1.0) as needed
    # --- Title slide attributes removed (or keep if you want different title settings) ---
#    title-slide-attributes:
#      # Keep specific title slide overrides here if needed
---
